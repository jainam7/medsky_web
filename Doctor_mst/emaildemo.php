...
$message="Respected Sir/Medam,<p>This is confidential information.Don`t Share this information with anybody.<b>Your password is ".$pass."</b></p>";
...
try {
   ...
   // $mail->SMTPDebug = 1;                                 // Enable verbose debug output
	...
	$mail->Subject = 'You had forgotten your password.';
	$mail->Body    = $message;
